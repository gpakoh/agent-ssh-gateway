...
|---------|----------------|----------|--------|----------|-------|
| Gateway | `agent-ssh-gateway-mcp` | `10.10.10.3:8788` | `/mcp` | `/etc/agent-ssh-gateway-mcp.env` | 62 |
| Context7 | `agent-mcp-context7` | `10.10.10.3:8790` | `/mcp/context7` | `/etc/agent-mcp-context7.env` | 2 |
| GitHub | `agent-mcp-github` | `10.10.10.3:8791` | `/mcp/github` | `/etc/agent-mcp-github.env` | 8 |
| Gitea | `agent-mcp-gitea` | `10.10.10.3:8792` | `/mcp/gitea` | `/etc/agent-mcp-gitea.env` | 12 |
| Docker | `agent-mcp-docker` | `10.10.10.3:8793` | `/mcp/docker` | `/etc/agent-mcp-docker.env` | 7 |
| Postgres | `agent-mcp-postgres` | `10.10.10.3:8794` | `/mcp/postgres` | `/etc/agent-mcp-postgres.env` | 6 |
...
All routes are in `/etc/nginx/sites-available/ssh.xloud.ru` on VPS `192.168.1.100`.
...
Each adapter's public port is opened for `10.10.10.0/24`:
...
ssh root@192.168.1.100 "tail -10 /var/log/nginx/error.log"
```
