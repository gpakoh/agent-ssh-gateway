...
DestructivePattern(
        ...
        suggestions=(
            PatternSuggestion(command="git push --force-with-lease", description="Safer force push — respects remote changes", kind=SuggestionKind.SAFER_ALTERNATIVE),
            PatternSuggestion(command="git push {remote} {branch}", description="Normal push without force", kind=SuggestionKind.SAFER_ALTERNATIVE),
        ),
    ),
DestructivePattern(
        ...
        suggestions=(
            PatternSuggestion(command="git remote -v", description="List remotes first", kind=SuggestionKind.PREVIEW_FIRST),
            PatternSuggestion(command="git push --all {remote}", description="Push all branches without mirror semantics", kind=SuggestionKind.SAFER_ALTERNATIVE),
        ),
    ),
DestructivePattern(
        ...
        suggestions=(
            PatternSuggestion(command="echo {arg}", description="Expand and review argument first", kind=SuggestionKind.PREVIEW_FIRST),
            PatternSuggestion(command="git push {remote} {branch}", description="Use an explicit refspec", kind=SuggestionKind.SAFER_ALTERNATIVE),
        ),
    ),
DestructivePattern(
        name="git-rebase",
        ...
        suggestions=(
            PatternSuggestion(command="git merge {branch}", description="Merge instead of rebase — preserves history", kind=SuggestionKind.SAFER_ALTERNATIVE),
            PatternSuggestion(command="git rebase --interactive HEAD~{n}", description="Interactive rebase with control", kind=SuggestionKind.SAFER_ALTERNATIVE),
        ),
    ),
DestructivePattern(
        ...
        suggestions=(
            PatternSuggestion(command="git commit --amend --no-edit", description="Amend without changing the message", kind=SuggestionKind.SAFER_ALTERNATIVE),
            PatternSuggestion(command="git log -1", description="Review last commit before amending", kind=SuggestionKind.PREVIEW_FIRST),
        ),
    ),
DestructivePattern(
        ...
        suggestions=(
            PatternSuggestion(command="git filter-repo --path {path}", description="Use filter-repo with path scope", kind=SuggestionKind.SAFER_ALTERNATIVE),
            PatternSuggestion(command="git clone {repo} /tmp/backup", description="Clone a backup before rewriting history", kind=SuggestionKind.PREVIEW_FIRST),
        ),
    ),
DestructivePattern(
        ...
        suggestions=(
            PatternSuggestion(command="git filter-repo --dry-run", description="Preview changes first", kind=SuggestionKind.PREVIEW_FIRST),
            PatternSuggestion(command="git clone {repo} /tmp/backup", description="Clone a backup before rewriting history", kind=SuggestionKind.PREVIEW_FIRST),
        ),
    ),
DestructivePattern(
        ...
        suggestions=(
            PatternSuggestion(command="git log --oneline -10", description="Review recent commits before picking", kind=SuggestionKind.PREVIEW_FIRST),
            PatternSuggestion(command="git merge {branch}", description="Merge instead of cherry-pick", kind=SuggestionKind.SAFER_ALTERNATIVE),
        ),
    ),
DestructivePattern(
        ...
        suggestions=(
            PatternSuggestion(command="git reflog show", description="Review reflog before expiring", kind=SuggestionKind.PREVIEW_FIRST),
            PatternSuggestion(command="git reflog expire --expire=90.days --all", description="Use a longer expiration time", kind=SuggestionKind.SAFER_ALTERNATIVE),
        ),
    ),
DestructivePattern(
        ...
        suggestions=(
            PatternSuggestion(command="git count-objects -vH", description="Check repo size before gc", kind=SuggestionKind.PREVIEW_FIRST),
            PatternSuggestion(command="git gc --auto", description="Run auto gc instead", kind=SuggestionKind.SAFER_ALTERNATIVE),
        ),
    ),
DestructivePattern(
        ...
        suggestions=(
            PatternSuggestion(command="git worktree list", description="List all worktrees first", kind=SuggestionKind.PREVIEW_FIRST),
            PatternSuggestion(command="git stash -u && git worktree remove {name}", description="Stash changes before removing", kind=SuggestionKind.PREVIEW_FIRST),
        ),
    ),
DestructivePattern(
        ...
        suggestions=(
            PatternSuggestion(command="git submodule status", description="Check submodule status first", kind=SuggestionKind.PREVIEW_FIRST),
            PatternSuggestion(command="git submodule deinit -f {name}", description="Force deinit if needed", kind=SuggestionKind.SAFER_ALTERNATIVE),
        ),
    ),
DestructivePattern(
        ...
        suggestions=(
            PatternSuggestion(command="git status", description="Review changes before staging", kind=SuggestionKind.PREVIEW_FIRST),
            PatternSuggestion(command="git add {specific-file}", description="Stage specific files only", kind=SuggestionKind.SAFER_ALTERNATIVE),
        ),
    ),
DestructivePattern(
