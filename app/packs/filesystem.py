...
FILESYSTEM_PATTERNS: tuple[DestructivePattern, ...] = (
    DestructivePattern(name="rm-rf-root",
        ...
        suggestions=(PatternSuggestion("rm -rf /path/to/specific/dir", "Target specific directories"),)),
    DestructivePattern(name="rm-rf-sensitive",
        ...
        suggestions=(PatternSuggestion("rm -rf /tmp/specific/subdir", "Use /tmp for temp deletions"),)),
    DestructivePattern(name="rm-rf",
        ...
        suggestions=(PatternSuggestion("rm -ri {path}", "Interactive mode"),)),
    DestructivePattern(name="rm-recursive",
        ...
        suggestions=(PatternSuggestion("rm -ri {path}", "Interactive confirmation"),)),
    DestructivePattern(name="find-delete",
        ...
        suggestions=(PatternSuggestion("find /tmp -type f | head -20", "Preview before deleting"),)),
    DestructivePattern(name="find-exec-rm",
        ...
        suggestions=(PatternSuggestion("find /tmp -type f | head -20", "Preview first"),)),
    DestructivePattern(name="dd-block-device",
        ...
        suggestions=(PatternSuggestion("lsblk", "List block devices first"),)),
    DestructivePattern(name="mkfs-destructive",
        ...
        suggestions=(PatternSuggestion("lsblk -f", "Check existing filesystems"),)),
    DestructivePattern(name="shred-destructive",
        ...
        suggestions=(PatternSuggestion("rm -P {file}", "Use rm -P for secure deletion"),)),
)
