...
ERROR_CODE_MAP: dict[tuple[int, str], str] = {
    ...
    (404, "allowlist"): "ALLOWLIST_ENTRY_NOT_FOUND",
...
HINTS: dict[str, str] = {
    ...
    "PROJECT_NOT_FOUND": "Use GET /api/workspace/projects to list registered projects",
    "ALLOWLIST_ENTRY_NOT_FOUND": "Use GET /api/admin/allowlist to list allowlist entries",
