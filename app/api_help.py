    ...
    return {
        ...
        "workspace_write_workflow": {
            ...
            "deploy_notes": {
                ...
                "overview": "Write/edit/patch endpoints are gated by the application setting WORKSPACE_READONLY (default: true). When true, all write endpoints return 403 WORKSPACE_READONLY. The Docker layer adds a second enforcement via read_only: true container + :ro volume mounts.",
                "modes": {
                    "default_readonly": {
                        "title": "Default — readonly (production)",
                        "description": "WORKSPACE_READONLY=true (default). Container filesystem read-only. All project volumes mounted :ro. Write/edit/patch return 403.",
                        ...
                        "result": "Write/edit/patch requests return 403 with code WORKSPACE_READONLY. Hint: set WORKSPACE_READONLY=false to enable.",
                    },
                    "write_test": {
