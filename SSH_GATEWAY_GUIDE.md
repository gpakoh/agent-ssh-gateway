...
| 192.168.1.103 | AI (Docker Host) | root | hjnjhbv2 |
| 192.168.1.100 | Nginx Proxy | root | hjnjhbv2 |
| 192.168.1.101 | Bitrix | root | hjnjhbv2 |
| 192.168.1.102 | Minecraft | root | hjnjhbv2 |
...
session = client.ssh_connect("192.168.1.103", username="root", password="hjnjhbv2")
...
#   "192.168.1.100": {"state": "open", "failure_count": 5}
# }
```
