#!/usr/bin/env python3
"""Remove the legacy gateway.example.com server block from AI-Docker.conf.
...
if end == -1:
    print('Cannot locate end of legacy gateway.example.com block')
    sys.exit(1)
...
print(f'Removed old gateway.example.com block from {path}')
