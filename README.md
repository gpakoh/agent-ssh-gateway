...
- **Размещение:** Docker @ LXC 103 (10.255.255.145)
- **Прокси:** Nginx @ LXC EXAMPLE + Authelia SSO
...
│   ├── docker-compose.yml   # Docker @ LXC 103, IP 10.255.255.145
│   └── requirements.txt     # Python dependencies
├── nginx-gateway.example.com.conf  # Nginx config for LXC EXAMPLE
